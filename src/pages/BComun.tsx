...
export default function BComun() {
              ...
              <div key={colIndex} className={styles.spaceColumn}>
                {column.map((space) => {
                  ...
                  return (
                    ...
                    >{ space.img1? 
                    <div >
                      <img src=  {space.img1} alt="img" width="100%" height="80%" className={styles.img1}></img>
                    ...
                    <><div>
                        ...
                        </div><span className={styles.spaceLabel}>{space.label}</span></>
                    }
