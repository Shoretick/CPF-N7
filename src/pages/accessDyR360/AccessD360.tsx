  ...
  return (
    <div className={styles.page}>
      ...
      <main className={styles.main} id="inicio">
        ...
        <LocationSectionDyR urlbtn1= "/accesodyr" subtitle="Acceso Dragones" description={"Usá las flechas táctiles para recorrer el espacio. Seguí las indicaciones de navegación y accedé a más información seleccionando los círculos que aparezcan en pantalla."} title={" Recorrido virtual del CFP N°7"} MAP_EMBED_URL={"/marzipano/Recorridos completos linkeados/Dragones hasta puerta principal CFP/app-files/index.html"}
/>
      </main>
    </div>
  )
